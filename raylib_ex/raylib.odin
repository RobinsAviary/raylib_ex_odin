...
foreign lib {
	...
	SetScreenshotKey   :: proc(key: KeyboardKey) ---         // Set a custom key to take a screenshot (default is F2)
	GetExitKey         :: proc() -> KeyboardKey ---          // Get the key to exit program (default is ESC)
	GetScreenshotKey   :: proc() -> KeyboardKey ---          // Get the key to take a screenshot (default is F2)
